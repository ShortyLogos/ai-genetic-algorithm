...
class CommunityPanel(gaapp.QSolutionToSolvePanel):
    ...
    def __init__(self, parent=None):
        ...
        #self._modele = modele()                ######     Context, Size, Personality      ######
        #self._problem = modeleProblem()        ######  Probablement 2 modèles différents  ######
    ...
    def __context_changed(self, choice):
        ...
        if choice != -1 and choice != custom_position:
            ...
            #self._vertex_widget.set_value(context[0])
            #self._concavity_widget.set_real_value(context[1])
