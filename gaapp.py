...
class QGAParametersWidget(QGroupBox):
    ...
    def update_from(self, parameter):
        ...
        self._population_size_widget = parameter.population_size
    ...
    def _update_adapter(self):
        ...
        self._ga_adapter.parameters.population_size = self._population_size_widget
...
class QSolutionPanels(QTabWidget):
    ...
    class _TabWidget(QWidget):
        def __init__(self, solution_panel):
            ...
            self._solution_panel.layout().contents_margins = QtCore.QMargins(0, 0, 0, 0)
